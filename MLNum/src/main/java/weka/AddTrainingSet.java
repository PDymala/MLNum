...
/**
 * Class to generate a training set for addition of two numbers. It generates a 100k random equations of number from 0 up to 10mln.
...
public class AddTrainingSet {
	...
	public AddTrainingSet(String fileName) {
