...
/**
 * Class to generate a training set for substraction of two numbers. It generates a 100k random equations of number from 0 up to 10mln.
 ...
 * @since 2021-05-10
 */
public class SubTrainingSet {

	public SubTrainingSet(String fileName) {
